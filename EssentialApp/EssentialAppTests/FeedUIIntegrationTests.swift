//
//  Created by Nazar Alwi on 09/06/21
...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedCompletion_redersSuccessfullyLoadedFeed() {
    ...
    func test_loadFeedCompletion_redersSuccessfullyLoadedEmptyFeedAfterNonEmptyFeed() {
    ...
    private func feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        let image0 = makeImage(url: URL(string: "http://url-0.com")!)
        let image1 = makeImage(url: URL(string: "http://url-1.com")!)
        let (sut, loader) = makeSUT()

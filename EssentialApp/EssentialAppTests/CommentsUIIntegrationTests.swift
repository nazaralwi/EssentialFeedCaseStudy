...
class CommentsUIIntegrationTests: FeedUIIntegrationTests {
    ...
    override func test_loadFeedCompletion_redersSuccessfullyLoadedFeed() {
    ...
    override func test_loadFeedCompletion_redersSuccessfullyLoadedEmptyFeedAfterNonEmptyFeed() {
